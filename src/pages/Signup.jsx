...
export default function Signup() {
  ...
  const handleSubmit = (e) => {
    ...
    // TODO (Supabase phase): replace with real auth, e.g.
    // const { error } = await supabase.auth.signUp({
    //   email: formData.email,
    //   password: formData.password,
    //   options: { data: { name: formData.name } },
    // });
    alert("Sign up isn't connected yet — coming soon!");
  };
    ...
    <div className="min-h-[70vh] flex items-center justify-center px-6 py-20">
      <div className="w-full max-w-md bg-studio-charcoal border border-studio-gray rounded-2xl p-8 md:p-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-4 top-1/2 -translate-y-1/2 text-studio-black/50 hover:text-studio-bluelight transition-colors"
          ...
          <button
            type="submit"
            className="w-full bg-studio-blue hover:bg-studio-bluelight transition-all duration-300 text-white py-3 rounded-md font-mono uppercase tracking-widest text-sm font-semibold"
          >
            Create Account
          </button>
        </form>
